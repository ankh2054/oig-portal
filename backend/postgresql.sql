...
FROM oig.adminsettings WHERE metasnapshot_date = timestamp '1980-01-01 00:00:00'
...
FROM oig.bizdev WHERE metasnapshot_date = timestamp '1980-01-01 00:00:00'
...
FROM oig.community WHERE metasnapshot_date = timestamp '1980-01-01 00:00:00'
...
FROM oig.pointsystem WHERE metasnapshot_date = timestamp '1980-01-01 00:00:00'
...
FROM oig.producer WHERE metasnapshot_date = timestamp '1980-01-01 00:00:00'
...
FROM oig.products WHERE metasnapshot_date = timestamp '1980-01-01 00:00:00'
...
FROM oig.results WHERE snapshot_date IS NOT NULL AND metasnapshot_date = timestamp '1980-01-01 00:00:00' ORDER BY owner_name, snapshot_date DESC;
