...
const IconWrapperStyle = styled('div')(({ theme }) => ({
  ...
  marginRight: '5px', //theme.spacing(1),
  color: 'white', //theme.palette.success.main,
...
export default function EcommerceWidgetSummary({ title, percent, total, chartColor, chartData }) {
  ...
  return (
    <Card sx={{ display: 'flex', alignItems: 'center', p: 3 }} style={{borderRadius: '10px'}}>
      <Box sx={{ flexGrow: 1 }}>
        ...
        <Stack direction="row" alignItems="center">
          <IconWrapperStyle
            sx={{
              ...(percent < 0 && {
                color: 'error.main',
                bgcolor: 'gray', //(theme) => alpha(theme.palette.error.main, 0.16),
              }),
            }}
          >
