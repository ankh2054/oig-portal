...
const SnapshotResults = ({ producers, products, bizdevs, community, snapresults, pointSystem, isAdmin, producerLogos, producerDomainMap, activeGuilds, metaSnapshotDate, formatDate, defaultMetaSnapshotDate }) => {
