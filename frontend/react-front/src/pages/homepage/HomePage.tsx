...
const HomePage = () => {
  ...
  const {
    data: latestResults,
    isLoading: isLatestResultsLoading,
    isError: isLatestResultsError,
  } = useGetLatestResultsQuery()

  if (isProducersLoading || isLatestResultsLoading) {
    return (
      <div
  ...
  if (isProducersError || isLatestResultsError) {
    return (
      <div
        className="mb-4 mb-4 h-12 rounded-lg bg-red-50 p-4 text-sm text-red-800"
        role="alert"
      >
